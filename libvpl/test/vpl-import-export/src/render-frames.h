...
#ifndef LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_RENDER_FRAMES_H_
#define LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_RENDER_FRAMES_H_
...
#endif // LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_RENDER_FRAMES_H_
