...
#ifndef LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_PROCESS_FRAMES_OCL_H_
#define LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_PROCESS_FRAMES_OCL_H_
...
#endif // LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_PROCESS_FRAMES_OCL_H_