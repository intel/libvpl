...
#ifndef LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_HW_DEVICE_H_
#define LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_HW_DEVICE_H_
...
#endif // LIBVPL_TEST_VPL_IMPORT_EXPORT_SRC_HW_DEVICE_H_
