...
#ifndef LIBVPL_TEST_VAL_SURFACE_SHARING_SRC_TIMING_H_
#define LIBVPL_TEST_VAL_SURFACE_SHARING_SRC_TIMING_H_
...
#endif // LIBVPL_TEST_VAL_SURFACE_SHARING_SRC_TIMING_H_