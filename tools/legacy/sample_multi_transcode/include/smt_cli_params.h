...
// Extended device ID info, available in 2.6 and newer APIs
    ...
    sInputParams()
            : TargetID(0),
              ...
              EncodeId(0),
              DecodeId(0),
              strSrcFile(MSDK_STRING("")),
              strDstFile(MSDK_STRING("")),
              strDumpVppCompFile(MSDK_STRING("")),
              strMfxParamsDumpFile(MSDK_STRING("")),
              strTCBRCFilePath(MSDK_STRING("")),
              nTargetUsage(0),
              ...
              numViews(0),
              nRotationAngle(0),
              strVPPPluginDLLPath(MSDK_STRING("")),
              decoderPluginParams(),
              encoderPluginParams(),
              nTimeout(0),
              nFPS(0),
